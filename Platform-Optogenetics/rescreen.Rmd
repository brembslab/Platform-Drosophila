...
colors=c("khaki","olivedrab3","cornflowerblue","goldenrod1","indianred1","plum3","green") #set the colors for the plots
...
```{r Wilcoxon, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE, fig.align = "center", fig.height = 7, fig.width = 16, comment=NA, results='asis'}
